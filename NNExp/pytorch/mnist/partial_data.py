...
def main():
    ...
    kwargs_train = {'pin_memory': True} if use_cuda_train else {}
    kwargs_test = {'pin_memory': True} if use_cuda_test else {}

    with utils.MeasureBlockTime("Data loading (s): "):
        train_loader, test_loader = DataTools.getDataLoaders(args.batch_size, args.test_batch_size, None, kwargs_train, kwargs_test)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print("Epoch: {}, train_loss: {:.2f}, test_loss: {:.2f}, accuracy:{:.4f}, TrainTime: {:.2f}, , TestTime: {:.2f}".format(
